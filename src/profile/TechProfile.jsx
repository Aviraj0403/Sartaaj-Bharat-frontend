...
export default function TechProfile() {
  ...
  const securityStats = [
    ...
    { label: "Saved Locations", value: "2 Points", icon: Activity, color: "text-indigo-500" },
  ...
  return (
    <div className="bg-white min-h-[70vh] max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-8">
        ...
        <div className="bg-slate-950 rounded-[3.5rem] p-10 md:p-14 relative overflow-hidden group border border-slate-900 shadow-2xl">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                 <div className="px-5 py-3 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-3 group/btn hover:bg-white/10 transition-all cursor-default">
                    <Terminal size={14} className="text-blue-500" />
                     <span className="text-[10px] font-black text-white uppercase tracking-widest italic">Member Status: Active</span>
                 </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-slate-50 border border-slate-100 rounded-[3.5rem] p-10 h-full flex flex-col justify-center text-center">
            ...
            <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest italic mb-3">
              Interaction Logs
            </p>
            <p className="text-slate-500 text-xs font-medium italic leading-relaxed max-w-[200px] mx-auto">
              Your recent interactions and account updates are synchronized across all devices.
            </p>
