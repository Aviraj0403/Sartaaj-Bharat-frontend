          ...
          >
            ...
            >
                    ...
                    <div className="flex-1">
                      <form onSubmit={handleSearch} className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-transparent border-none outline-none text-3xl md:text-4xl font-bold text-slate-900 pl-14 py-4 placeholder:text-slate-300"
                        />
                      </form>
                    </div>
                    <button
                      onClick={() => setIsSearchOpen(false)}
                      className="p-3 rounded-full hover:bg-slate-100 text-slate-400 hover:text-slate-900 transition-all"
                    >
              ...
              <div className="max-w-7xl mx-auto px-8 py-12">
                ...
                <div className="mb-16">
                  <h3 className="text-xs font-black uppercase tracking-wider text-slate-400 mb-8">
                    POPULAR CATEGORIES
                  </h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {categories?.slice(0, 10).map((cat) => (
                      <Link
                        ...
                        to={`/category/${cat.slug}`}
                        onClick={() => setIsSearchOpen(false)}
                        className="group p-6 bg-slate-50 hover:bg-blue-50 rounded-2xl transition-all text-center"
                      >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <button
                        ...
                        className="px-6 py-3 bg-slate-50 hover:bg-blue-600 hover:text-white rounded-full text-sm font-medium text-slate-600 transition-all"
                      >
                        {tag}
                      </button>
                    ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-3xl p-8 hover:shadow-xl transition-all group cursor-pointer">
                    <h4 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-blue-600">New Arrivals</h4>
                    <p className="text-sm text-slate-500 mb-4">Discover the latest products</p>
                    <Link 
                      to="/new-arrivals" 
                      onClick={() => setIsSearchOpen(false)}
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl p-8 hover:shadow-xl transition-all group cursor-pointer">
                    <h4 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-orange-600">Best Sellers</h4>
                    <p className="text-sm text-slate-500 mb-4">Most popular items</p>
                    <Link 
                      to="/best-sellers" 
                      onClick={() => setIsSearchOpen(false)}
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 hover:shadow-xl transition-all group cursor-pointer">
                    <h4 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-blue-600">Special Offers</h4>
                    <p className="text-sm text-slate-500 mb-4">Limited time deals</p>
                    <Link 
                      to="/offers" 
                      onClick={() => setIsSearchOpen(false)}
                      className="text-xs font-bold uppercase tracking-wider text-blue-600"
                ...
                <div className="mt-16 pt-8 border-t border-slate-100">
                  <p className="text-xs text-slate-400 text-center">
                    Search by product name, category, brand, or SKU
                  </p>
                </div>
              </div>
            </motion.div>
