      ...
      <div className="container-custom py-6 flex items-center justify-between gap-12">
        ...
        <div className="flex flex-1 max-w-2xl">
          <form onSubmit={handleSearch} className="relative w-full group">
            ...
            />
            <Search
              className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-blue-600 transition-colors"
              size={22}
            />
            <button
              type="submit"
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-1">
            ...
            <Link
              ...
              className="p-3 rounded-2xl hover:bg-slate-100 text-slate-600 hover:text-blue-600 transition-all group"
            >
          ...
          >
            <div className="container-custom flex items-center justify-between gap-8 mb-12">
              ...
              <button
                ...
                className="p-4 rounded-full bg-slate-100 hover:bg-slate-200 transition-all"
              >
                <X size={32} />
              </button>
            </div>
            ...
            <div className="container-custom flex-1">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
                <div>
                  <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 mb-8 italic">
                    Quick Access
                  </h4>
                  <div className="flex flex-col gap-6">
                    {categories?.slice(0, 5).map((cat) => (
                      <Link
                        ...
                        to={`/category/${cat.slug}`}
                        onClick={() => setIsSearchOpen(false)}
                        className="text-2xl font-black italic hover:text-blue-600 transition-colors"
                      >
                        {cat.name}
                      </Link>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-4">
                    {[
                      ...
                      <button
                        ...
                        className="px-6 py-3 bg-slate-100 rounded-full text-xs font-black uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all italic"
                      >
                        {tag}
                      </button>
                    ))}
