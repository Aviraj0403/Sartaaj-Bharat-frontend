...
import { Search, ShoppingCart, User, Heart, Phone, Mail, ChevronDown, X } from 'lucide-react';
...
const DesktopHeaderElite = () => {
    ...
    return (
        <header className={`w-full z-50 transition-all duration-500 hidden lg:block ${isScrolled ? 'sticky top-0 bg-white/90 backdrop-blur-xl border-b border-slate-200 shadow-lg shadow-slate-200/20' : 'relative bg-white'}`}>
