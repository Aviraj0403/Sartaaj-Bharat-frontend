...
const Header = () => {
  ...
  return (
    <header
      className={`w-full z-50 transition-all duration-700 ${isScrolled ? "sticky top-0 bg-white/70 backdrop-blur-2xl border-b border-slate-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)]" : "relative bg-white"}`}
    >
      ...
      {/* Main Navigation Hub */}
      <div
        className={`container-custom transition-all duration-500 ${isScrolled ? "py-3" : "py-6 md:py-8"} flex items-center justify-between gap-12`}
      >
        {/* Brand Identity */}
        <Link to="/" className="flex-shrink-0 group relative">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-black text-slate-400 tracking-[0.5em] uppercase mt-1.5 opacity-60">
                Prime Sovereign
              </span>
            </div>
          </motion.div>
        ...
        <div className="hidden lg:flex flex-1 max-w-2xl px-8 relative">
          <form onSubmit={handleSearch} className="relative w-full group">
            <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
              <Search
                className={`transition-all ${isFocused ? "text-blue-600 scale-110" : "text-slate-400 group-hover:text-blue-500"}`}
                size={20}
                strokeWidth={2.5}
              />
            </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <button
                          ...
                          className="px-5 py-2.5 bg-slate-50 hover:bg-blue-50 hover:text-blue-600 rounded-xl text-xs font-bold text-slate-600 transition-all border border-slate-100"
                        >
                          {item}
                        </button>
                      ))}
                        ...
                        <div className="px-2 space-y-1">
                          {searchResults.products.map((p) => (
                            ...
                            >
                              ...
                              <ChevronDown
                                size={14}
                                className="text-slate-300 group-hover:text-blue-500 -rotate-90 transition-transform opacity-0 group-hover:opacity-100"
                              />
                            </Link>
                          ))}
                          <button
                          ...
                          >
                            Explore all matching artifacts{" "}
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <div className="flex items-center">
            <Link
              to="/wishlist"
              className="p-4 rounded-2xl hover:bg-slate-50 text-slate-500 hover:text-blue-600 transition-all relative group"
            >
              <Heart
                size={22}
                strokeWidth={2.5}
              ...
              />
              <span className="absolute top-2.5 right-2.5 w-5 h-5 bg-blue-600 text-white text-[9px] font-black rounded-lg flex items-center justify-center border-2 border-white shadow-xl group-hover:-translate-y-1 transition-transform">
                0
              </span>
            </Link>
            ...
            <Link
              ...
              className="p-4 rounded-2xl hover:bg-slate-50 text-slate-500 hover:text-blue-600 transition-all group"
            >
              <User
                size={22}
                strokeWidth={2.5}
            ...
            <Link
              to="/cart"
              className="flex items-center gap-5 px-6 py-4 bg-slate-950 hover:bg-blue-600 rounded-[1.4rem] text-white transition-all shadow-2xl shadow-slate-950/20 hover:shadow-blue-500/40 active:scale-95 group relative overflow-hidden"
            >
              ...
              <div className="relative flex items-center gap-3">
                ...
                <span className="text-[10px] font-black hidden xl:block uppercase tracking-[0.2em] italic">
                  Archive
                </span>
              </div>
            </Link>
          ...
          >
            ...
            <div className="container-custom flex items-center justify-between gap-8 mb-20 relative z-10">
              ...
              <button
                ...
                className="w-20 h-20 rounded-full bg-white/5 hover:bg-white/10 text-white transition-all flex items-center justify-center border border-white/10 backdrop-blur-xl group"
              >
                <X
                  size={40}
            ...
            <div className="container-custom flex-1 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-24">
                ...
                >
                  <h4 className="text-[10px] font-black uppercase tracking-[0.5em] text-blue-500 mb-10 italic">
                    Archive Branches
                  </h4>
                  <div className="flex flex-col gap-8">
                    {categories?.slice(0, 5).map((cat, i) => (
                      ...
                      >
                        <span className="text-[10px] opacity-20 font-sans group-hover:opacity-100">
                          0{i + 1}
                        </span>
                        {cat.name}
                      </Link>
