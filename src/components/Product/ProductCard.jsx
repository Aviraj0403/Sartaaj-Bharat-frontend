        ...
        <div className="absolute top-6 left-6 z-20 flex flex-col gap-2">
          {product.isFeatured && (
            <motion.span
              ...
              className="bg-slate-900 text-white text-[9px] font-black px-4 py-2 rounded-xl uppercase tracking-[0.2em] shadow-2xl flex items-center gap-2 border border-slate-700/50"
            >
              <Sparkles size={10} className="text-blue-400" /> Signature
            </motion.span>
          )}
          {product.discount > 0 && (
            <span className="bg-blue-600 text-white text-[9px] font-black px-4 py-2 rounded-xl uppercase tracking-[0.2em] shadow-2xl">
