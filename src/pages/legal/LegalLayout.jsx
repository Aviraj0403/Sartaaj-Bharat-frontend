...
const LegalLayout = ({ title, lastUpdated, children }) => {
  return (
    <div className="min-h-screen bg-slate-950 py-12 md:py-24 relative overflow-hidden selection:bg-blue-600 selection:text-white">
      ...
      <div
        className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-600/10 blur-[120px] rounded-full -translate-x-1/3 translate-y-1/3 animate-pulse"
