    ...
    <section className="bg-white min-h-screen">
      ...
      <div className="grid md:grid-cols-4 gap-8 max-w-7xl mx-auto px-4 -mt-12 mb-24 relative z-10">
        <div className="bg-white shadow-2xl rounded-[2.5rem] p-10 text-center border border-slate-100 hover:border-blue-600 transition-all group">
          ...
          <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-3 italic">
            Audio Link
          </h3>
        ...
        <div className="bg-white shadow-2xl rounded-[2.5rem] p-10 text-center border border-slate-100 hover:border-blue-600 transition-all group">
          ...
          <p className="text-slate-900 font-black italic text-[10px] leading-relaxed uppercase">
            11021, 5A Block WEA, Sat Nagar, Karol Bagh, Delhi, 110005
          </p>
        </div>
        ...
        <div className="bg-white shadow-2xl rounded-[2.5rem] p-10 text-center border border-slate-100 hover:border-blue-600 transition-all group">
          ...
          <p className="text-slate-900 font-black italic uppercase">
            Mon – Sat: 0900 – 1900
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 px-4 pb-16">
        ...
        <div className="bg-white p-12 rounded-[3rem] shadow-2xl border border-slate-100 relative overflow-hidden group">
          ...
          <h2 className="text-3xl font-black text-slate-950 mb-8 italic uppercase tracking-tighter">
            INITIATE <span className="text-blue-600">OVERRIDE.</span>
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-24">
        <div className="bg-slate-900 rounded-[4rem] shadow-2xl p-16 grid md:grid-cols-3 gap-16 border border-white/5">
          <div className="relative">
            <div className="text-blue-600 font-black text-[10px] mb-4 uppercase tracking-[0.3em] italic">
              01. Priority Support
            </div>
            <h3 className="text-xl font-black text-white mb-4 italic uppercase tracking-tighter">
              NEURAL ASSISTANCE
            </h3>
            <p className="text-slate-400 font-medium text-sm leading-relaxed uppercase tracking-wider">
              Available 24/7 for artifact inquiries, precision logistics, or
              terminal encryption support.
            </p>
          </div>

          <div className="relative">
            <div className="text-blue-600 font-black text-[10px] mb-4 uppercase tracking-[0.3em] italic">
              02. Strategic Alliance
            </div>
            <h3 className="text-xl font-black text-white mb-4 italic uppercase tracking-tighter">
              PROTOCOL MERGER
            </h3>
            <p className="text-slate-400 font-medium text-sm leading-relaxed uppercase tracking-wider">
              For enterprise logic, bulk asset acquisition, or strategic
              influencer syncs—initiate contact now.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <p className="text-slate-400 font-medium text-sm leading-relaxed uppercase tracking-wider">
              Monitor your asset coordinates or request logistical adjustments
              directly with our dispatch tier.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-600 py-24 text-white text-center px-4 relative">
        <h2 className="text-4xl md:text-5xl font-black mb-6 italic uppercase tracking-tighter">
          OPTIMIZE YOUR <span className="text-slate-950">EXPERIENCE.</span>
        </h2>
        <p className="max-w-2xl mx-auto text-sm font-black uppercase tracking-[0.3em] mb-10 opacity-80 leading-relaxed italic">
          Have algorithmic suggestions or special protocol requests? Your
          feedback drives our evolution.
        </p>
