    ...
    <section className="bg-slate-50 min-h-screen">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center py-16 px-4 md:px-16">
        <div>
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-950 mb-8 italic uppercase tracking-tighter">
            OUR <span className="text-blue-600">MISSION.</span>
          </h2>
          <div className="space-y-6">
            <p className="text-slate-600 font-medium leading-relaxed">
              At SarTaaj Bharat, we believe that aesthetic excellence is not
              just a surface-level pursuit—it’s an engineered experience that
              empowers your core architecture. Our elite selection is rigorously
              benchmarked to enhance your natural radiance with artifacts that
              are as technically superior as they are visually stunning.
            </p>
            <p className="text-slate-600 font-medium leading-relaxed">
              Every asset in our vault is curated using the highest industry
              protocols, ensuring only the most refined formulations reach your
              interface. We are committed to absolute precision, cruelty-free
              innovation, and the evolution of self-care rituals.
            </p>
          </div>
        </div>
        <img
      ...
      <div className="bg-slate-900 py-24 text-center relative overflow-hidden">
        ...
        <h2 className="text-2xl font-black text-white mb-16 italic uppercase tracking-[0.2em] opacity-40">
          System Benchmarks
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-10 py-24 px-4 md:px-16">
        <div className="bg-white p-12 rounded-[3rem] shadow-xl border border-slate-100 hover:border-blue-600 transition-all text-center group">
          ...
          <h3 className="text-3xl font-black mb-4 italic uppercase tracking-tighter text-slate-900">
            CORE <span className="text-blue-600">MISSION</span>
          </h3>
          <p className="text-slate-500 font-medium">
            To provide handpicked, high-precision artifacts that empower the
            individual and define global standards of aesthetic excellence.
          </p>
        </div>
        <div className="bg-slate-900 p-12 rounded-[3rem] shadow-xl border border-slate-800 hover:border-blue-600 transition-all text-center group">
          ...
          <h3 className="text-3xl font-black mb-4 italic uppercase tracking-tighter text-white">
            THE <span className="text-blue-600">VISION</span>
          </h3>
          <p className="text-slate-400 font-medium">
            To evolve as the architect of India's most trusted premium lounge,
            defined by authenticity and a customer-centric quantum experience.
          </p>
        </div>
      </div>
      ...
      <div className="text-center py-24 px-4 md:px-16 bg-slate-50">
        <h2 className="text-2xl font-black text-slate-400 mb-16 italic uppercase tracking-[0.3em]">
        ...
        <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          <div className="bg-white rounded-[2.5rem] shadow-sm p-12 hover:shadow-2xl transition-all text-center border border-slate-100 border-b-4 border-b-blue-600">
            ...
            <h3 className="font-black text-2xl mb-4 italic uppercase tracking-tighter">
              CLIENT DEVOTION
            </h3>
            <p className="text-slate-500 font-medium text-sm">
              Personalized concierge protocols and a seamless neural interface
              for every user.
            </p>
          </div>
          <div className="bg-white rounded-[2.5rem] shadow-sm p-12 hover:shadow-2xl transition-all text-center border border-slate-100 border-b-4 border-b-blue-600">
            ...
            <p className="text-slate-500 font-medium text-sm">
              Only verified elite assets cross our perimeter. Guaranteed
              authenticity.
            </p>
          </div>
          <div className="bg-white rounded-[2.5rem] shadow-sm p-12 hover:shadow-2xl transition-all text-center border border-slate-100 border-b-4 border-b-blue-600">
            ...
            <p className="text-slate-500 font-medium text-sm">
              Every artifact is algorithmically selected to bring sophistication
              and beauty.
            </p>
          </div>
        </div>
      ...
      <div className="py-24 px-4 md:px-16">
        <h2 className="text-2xl font-black text-slate-400 mb-16 text-center italic uppercase tracking-[0.3em]">
          VALIDATION REVIEWS
        </h2>
          ...
          {[
            {
              name: "Anjali Sharma",
              feedback:
                "The curated artifacts are superior. The tech interface and service are beyond industry standards.",
            },
            {
              name: "Priya Singh",
              feedback:
                "Fast encryption-to-delivery and excellent neural support. Highly recommend the SarTaaj Experience.",
            },
            {
              name: "Ritu Verma",
              feedback:
                "The selection is elite. Every artifact feels mathematically optimized for elegance.",
            },
          ].map((item, idx) => (
            <div
              key={idx}
              className="bg-white p-10 rounded-[2rem] shadow-sm border border-slate-100 relative group"
            >
              ...
              <h4 className="font-black text-blue-600 uppercase tracking-widest text-xs italic">
                // {item.name}
              </h4>
            </div>
          ))}
      ...
      <div className="text-center py-24 bg-slate-900 relative">
        ...
        <h2 className="text-4xl md:text-5xl font-black text-white mb-6 italic uppercase tracking-tighter">
          SYNC WITH THE <span className="text-blue-600">COMMUNITY.</span>
        </h2>
        <p className="text-slate-400 mb-10 max-w-2xl mx-auto font-medium text-sm leading-relaxed uppercase tracking-wide">
          AUTHORIZE ACCESS TO THE LATEST NEURAL REWARDS, EXCLUSIVE ARTIFACT
          DEFAULTS, AND ELITE PROTOCOLS.
        </p>
