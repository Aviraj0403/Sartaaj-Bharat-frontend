        ...
        <div className="container-custom">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter italic mb-8">
              Results for:{" "}
              <span className="text-blue-600 underline underline-offset-[12px] decoration-4">
                "{query}"
              </span>
            </h1>
            <p className="text-slate-400 font-black text-[10px] uppercase tracking-[0.3em] flex items-center gap-3">
              {data?.products?.length || 0} Artifacts Indexed{" "}
              <span className="w-12 h-[1px] bg-slate-200"></span> Lounge
              Standard
            </p>
          </motion.div>
        </div>
          ...
          <aside className="w-full lg:w-64 space-y-12 mb-10 lg:mb-0">
            <div className="lg:sticky lg:top-32">
              ...
              <div className="space-y-10 p-4">
                <div>
                  <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-300 mb-6">
                    Conditions
                  </h3>
              ...
              {isLoading ? (
                ...
                >
                  ...
                  <p className="text-slate-400 font-medium text-lg mb-12 max-w-sm mx-auto">
                    None of our indexed artifacts match the requested intel
                    signature:{" "}
                  ...
                  <Link
                    to="/"
                    className="inline-flex items-center gap-3 bg-slate-900 text-white px-10 py-4 rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-blue-600 shadow-2xl transition-all italic"
                  >
