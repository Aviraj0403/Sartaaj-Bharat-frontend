      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="space-y-8">
          ...
          <p className="text-base font-medium text-slate-500 max-w-md leading-relaxed uppercase tracking-wider italic">
            EXPERIENCE THE PRECISION OF ELITE DERMATOLOGICAL ASSETS CRAFTED FOR
            QUANTUM RADIANCE. EVOLVE YOUR VISUAL INTERFACE EFFORTLESSLY.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-6 group">
              ...
              <p className="text-slate-900 font-black text-xs uppercase tracking-widest italic">
                PREMIUM ACTIVE NODES
              </p>
            </div>
            <div className="flex items-center gap-6 group">
